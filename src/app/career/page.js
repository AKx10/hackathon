    ...
    <div className="flex h-[100vh] flex-col items-center justify-between p-24 bg-black">
      <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
        <div className="fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none">
          ...
          >
            check <p className={`m-0 max-w-[30ch] text-xl text-white`}>Career</p>
          </a>
        </div>
      </div>
      <div className="flex flex-1 items-center justify-center flex-row gap-x-10 min-w-[700px]">
        <div className="card w-96 bg-blue-900/10 shadow-xl image-full h-[300px]">
          <figure>
            <img src="/exploreCareer.png" alt="Explore Career" />
          </figure>
          <div className="card-body ">
            <h2 className="card-title text-white font-mono text-white">Explore All Careers</h2>
            <p className="text-white font-mono">Learn more about the different career</p>
            <div className="card-actions justify-end">
              <button className="btn btn-primary font-mono text-white" onClick={() => {navigate.push('/career/allCareer')}}>Explore {'->'}</button>
            </div>
          </div>
        </div>
        <div className="card w-96 bg-blue-900/10 shadow-xl image-full h-[300px]">
          ...
          <div className="card-body">
            <h2 className="card-title text-white font-mono text-white">Match My Career Interest</h2>
            <p className="text-white font-mono text-white">Research career that meets your interest</p>
            <div className="card-actions justify-end text-white">
              <button className="btn btn-primary font-mono text-white" onClick={() => {navigate.push('/career/myIntrest')}}>Go In {'->'}</button>
            </div>
          </div>
        </div>
      </div>
