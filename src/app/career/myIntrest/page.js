    ...
    <div className="flex h-[100vh] flex-col items-center justify-between p-24 overflow-scroll bg-black">
      <div className="z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex">
        <div className="fixed bottom-0 left-0 flex h-48 w-full items-end justify-center bg-gradient-to-t from-white via-white dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none">
          ...
          >
            my <p className={`m-0 max-w-[30ch] text-xl text-white`}>Interest</p>
          </a>
        </div>
      </div>
                ...
                <div className="card-body">
                  <div className="flex flex-col gap-x-5 justify-center  bg-white/10 px-5 py-2 rounded-md">
                    ...
                    <div className="flex flex-row items-center gap-x-5">
                      <progress
                        className="progress progress-accent w-56 font-mono text-white"
                        value={career?.matchPercentage}
                        max="100"
                      ></progress>
                      <p className="text-white font-mono text-white">{career?.matchPercentage}%</p>
                    </div>
                  </div>
