(function (global, factory) {
  ...
  var AdvertiserUTMTracker = /*#__PURE__*/function () {
    ...
    return _createClass(AdvertiserUTMTracker, null, [{
      ...
      value: function getTotalSessionDuration() {
        var live = !this.isPaused && this.sessionStartTime !== null ? performance.now() - this.sessionStartTime : 0;
      ...
      value: function resolveIdentity() {
        var _this = this;
        Promise.all([this.fingerprintManager.getCustomFingerprint(), new DeviceInfoCollector({
          logger: this.logger
        }).getDeviceInfo()]).then(function (_ref) {
      ...
      value: function setupLifecycle() {
        ...
        window.addEventListener("pagehide", function () {
          if (Date.now() - _this2.lastFlushTs < _this2.FLUSH_GUARD_THRESHOLD_MS) return;
          _this2.flushSessionEvent(true);
        });
      ...
      // Passive navigation observer — does NOT touch history APIs
    }, {
      ...
      value: function setupNavigationObserver() {
        ...
        try {
          new PerformanceObserver(function (list) {
            ...
            try {
              for (_iterator.s(); !(_step = _iterator.n()).done;) {
                ...
                // Skip the initial page load entry
                var navEntry = entry;
                if (navEntry.type === "navigate" && entry.startTime < 1000) continue;
          ...
          // PerformanceObserver navigation type unsupported — silently degrade
        }
      }
    }, {
      ...
      value: function flushSessionEvent(useBeacon) {
        ...
        if (duration <= 0 || duration === this.latestSessionTimeEventSent) return;
        ...
        try {
          var payload = _objectSpread2(_objectSpread2({
            ...
            fingerPrintType: ((_c = this.cachedFingerprint) === null || _c === void 0 ? void 0 : _c.version) ? "signalHash_" + this.cachedFingerprint.version : undefined
          ...
          if (useBeacon && navigator.sendBeacon) {
            var sent = navigator.sendBeacon(endpoint, new Blob([data], {
            ...
            if (!sent) {
              ...
              fetch(endpoint, {
                ...
                return _this4.logger.error("SESSION_DURATION keepalive fetch failed");
              });
            }
          } else {
            fetch(endpoint, {
      ...
      value: function resolveAttributionParams() {
        try {
          ...
          if (utmParams.utm_source || utmParams.utm_campaign || utmParams.utm_data) {
            localStorage.setItem(this.UTM_LOCAL_STORAGE_KEY, JSON.stringify(_objectSpread2(_objectSpread2({}, utmParams), {}, {
              timestamp: Date.now()
            })));
            return utmParams;
          }
          ...
          if (storedAttribution) {
            ...
            if (Date.now() - parsed.timestamp < this.UTM_ATTRIBUTION_EXPIRATION_MS) {
      ...
      key: "initialize",
      value: function () {
        var _initialize = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(adTrackingUrl) {
          return _regenerator().w(function (_context) {
  ...
  AdvertiserUTMTracker.sendEvent = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(eventType) {
      var additionalData,
        _b,
        _c,
        utmParams,
      ...
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.p = _context2.n) {
          case 0:
            additionalData = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : {};
            ...
            payload = _objectSpread2(_objectSpread2({
              ...
              fingerPrintType: ((_c = _a.cachedFingerprint) === null || _c === void 0 ? void 0 : _c.version) ? "signalHash" + _a.cachedFingerprint.version : undefined
            }, _a.cachedDeviceInfo), {}, {
  ...
  AdvertiserUTMTracker.sendVisitEvent = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
